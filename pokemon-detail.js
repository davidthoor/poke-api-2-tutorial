...
async function loadPokemon(id) {
  try {
    ...
    if (currentPokemonId === id) {
      ...
      const flavorText = getEspanolFlavorText(pokemonSpecies);
    ...
    console.error("Ocurrio un error al consultar datos:", error);
    return false;
  }
}
...
function getEspanolFlavorText(pokemonSpecies) {
